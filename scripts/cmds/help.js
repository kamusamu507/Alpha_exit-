...
      const helpMessage = `┍━━━[ 📚 ${toBold("BABY HELP")} ]━━━◊
...
        await message.reply({
          body: helpMessage,
          attachment: await global.utils.getStreamFromURL("https://i.ibb.co/tTHBtPHj/183b40e272c1.gif")
        });
      } catch (error) {
...
    msg += `┍━━━[ 🚀 ${toBold("INFO")} ]━━━◊
┋➥ ${toBold("Welcome to baby Bot!")}
┋➥ ${toBold("Prefix")}: [ ${prefix} ]
┋➥ ${toBold("Developer")}: 𝐋𝐮𝐜𝐢𝐟ē𝐫𝐢𝐚𝐧 𝐈𝐈
